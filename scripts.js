const rounds = [
    ...
    { letter: "A", category: "Colours", answers: ["aqua", "amethyst", "amber", "aquamarine", "apricot", "arctic lime", "ash grey", "azure", "avocado"] },
    ...
    { letter: "D", category: "Girls' names", answers: ["Delilah", "Daphne", "Diana", "Daisy", "Darcie", "Dorothy", "Danielle"] },
    { letter: "G", category: "Things that are sticky", answers: ["Glue", "Gum", "Gel", "Golden syrup", "Glaze", "Grapefruit marmalade"] },
    { letter: "R", category: "Job titles", answers: ["Recruiter", "Roofer", "Research Assistant", "Regional Manager", "Registered Nurse", "Radiologist", "Risk Analyst", "Robotics Engineer"] },
];
